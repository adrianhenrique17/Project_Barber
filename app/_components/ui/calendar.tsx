...
// tipagem correta do DayButton
type CalendarDayButtonProps = NonNullable<
  NonNullable<DayPickerProps["components"]>["DayButton"]
>

const CalendarDayButton: CalendarDayButtonProps = ({
  className,
  day,
  modifiers,
  ...props
